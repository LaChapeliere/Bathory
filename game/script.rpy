...
define fwey = Character("Frogwey", kind=c, show_tint="#8d665b")
...
define tx = Character("Toadlax", kind=c, show_tint="#9a706a")
...
define ca = Character("Croakma", kind=c, show_tint="#99BDE3")
