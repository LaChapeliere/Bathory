...
translate french taddeus_intro_dfaecce8:
    ...
    ts "On m'a dit que l'on pouvait venir apporter nos ennuis dans votre établissement et repartir de ces bains l'esprit clair ?"

# game/dialogue_taddeus.rpy:12
translate french taddeus_intro_2a5ac269:

    # p "We try our best."
    p "Nous essayons de faire de notre mieux."
...
translate french taddeus_intro_4cef2002:
    ...
    ts "Oh, des bombes de bain ? Puis-je choisir l'odeur ?"
...
translate french taddeus_intro_e424d650:
    ...
    p "Je suis la seule à pouvoir choisir les ingrédients pour vous."
...
translate french taddeus_intro_0e316bd2:
    ...
    p "Bien équilibrer la composition pour induire les émotions désirées demande de l'expérience..."
...
translate french taddeus_intro_ebfeea18:
    ...
    ts "Oh, mes plus plates excuses, je ne voulais pas mésestimer vos talents."
...
translate french taddeus_intro_90dd2aad:
    ...
    p "Est-ce qu'il y a une raison spécifique pour laquelle vous visitez nos bains aujourd'hui ?"
...
translate french taddeus_intro_53a675c0:
    ...
    ts "Ce n'est pas ma première fois en tant que Vraiment très Importante Présence, mais j'ai l'impression que ça devient de pire en pire chaque année."
...
translate french taddeus_intro_93fbacab:
    ...
    ts "Dites-vous, juste ce matin, j'ai appris que des sycophantes sans esprit ont créé un club pour noter chacun de mes goûts !"

# game/dialogue_taddeus.rpy:38
translate french taddeus_intro_e119dab6:

    # ts "Music, holiday spots, coitus positions..."
    ts "Musique, lieux de villégiature, positions de coït..."

# game/dialogue_taddeus.rpy:39
translate french taddeus_intro_fb430960:

    # ts "They dissect my every move!"
    ts "Ils dissèquent le moindre de mes gestes !"
...
translate french taddeus_intro_603db3f7:
    ...
    ts "Je n'en suis plus si sûr à présent."
...
translate french taddeus_intro_2fca4b93:
    ...
    ts "Et je crois toujours à cela..."
...
translate french taddeus_intro_a34d903a:
    ...
    ts "Mais ces temps-ci, j'ai l'impression que les gens attendent de mes bâtiments qu'ils fassent tout le travail pour eux."
...
translate french taddeus_intro_f9e9fb33:
    ...
    p "Je comprends votre frustration."
...
translate french taddeus_intro_0d02f241:
    ...
    ts "Je suis à ça d'accepter la proposition de ma cousine et de la rejoindre dans sa ferme à thé."
...
translate french taddeus_intro_58208ca8:
    ...
    p "Donnez-moi une minute pour préparer votre bombe de bain."

# game/dialogue_taddeus.rpy:64
translate french taddeus_intro_9da61d8d:

    # p "Here it is, please enjoy your bath!"
    p "Voici, s'il vous plaît, profitez de votre bain !"
...
translate french taddeus_postbath_revenge_c2d59a7c:
    ...
    ts "Ce bain a été vraiment éclairant, effectivement !"
...
translate french taddeus_postbath_revenge_dccdf403:
    ...
    ts "Dans tous les cas, je reviendrai ici pendant le prochain festival !"
...
translate french taddeus_postbath_teafarm_61e93d8e:
    ...
    p "Avez-vous apprécié votre bain ?"
...
translate french taddeus_postbath_teafarm_8e054aad:
    ...
    ts "Je n'avais pas ressenti autant de paix et de calme depuis un long moment !"
...
translate french taddeus_postbath_teafarm_4430f07d:
    ...
    ts "Si un court bain dans un endroit si tranquille me donne autant d'énergie, peut-être est-ce un signe."
...
translate french taddeus_postbath_teafarm_1297425f:
    ...
    # p "Goodbye, take care."
    p "À bientôt, prenez soin de vous."
...
translate french taddeus_postbath_priceoffame_a4e4214c:
    ...
    ts "Je peux même dire qu'il a dépassé mes attentes ! Mon chemin est plus clair maintenant."
...
translate french taddeus_postbath_priceoffame_4b7145d8:
    ...
    ts "J'ai constaté que je n'avais aucune raison de me plaindre."
...
translate french taddeus_postbath_priceoffame_b6bd1ce8:
    ...
    ts "Mon travail est ma passion, je suis adulé pour ça et mon futur est assuré."
...
translate french taddeus_postbath_priceoffame_f765527d:
    ...
    p "Je suis sûr que ça ne serait pas si terrible !"
...
translate french taddeus_postbath_priceoffame_2505791a:
    ...
    ts "Au revoir. Merci pour le bain."
...
translate french taddeus_postbath_priceoffame_f9721cd5:
    ...
    ts "Et si je décide qu'il ne l'est pas ?"
...
translate french taddeus_postbath_priceoffame_218e7987:
    ...
    p "Vous avez parler de l'invitation de votre cousine pour travailler dans une ferme de thé..."
...
translate french taddeus_postbath_priceoffame_b95abeaf:
    ...
    ts "C'est une pensée plaisante, mais je dois rester réaliste."
...
translate french taddeus_postbath_priceoffame_ded79523:
    ...
    ts "Je ne peux pas fuir mes responsabilités."
...
translate french taddeus_postbath_priceoffame_7229b40b:
    ...
    ts "Et si je veux m'évader quelques heures, je peux revenir ici, n'est-ce pas ?"
...
translate french taddeus_postbath_priceoffame_7d70f49e:
    ...
    ts "Jusqu'à ma prochaine visite alors."

translate french strings:

    # game/dialogue_taddeus.rpy:10
    old "We try our best."
    new "Nous essayons de faire de notre mieux."
    ...
    new "Hum, vous êtes celui qui a construit l'opéra Aquadiva, non ?"
    ...
    new "Je vous souhaite bonne chance pour la ferme à thé alors."

    # game/dialogue_taddeus.rpy:141
    old "When are you planning to move?"
    new "Quand allez-vous partir ?"

    # game/dialogue_taddeus.rpy:170
    old "Is something wrong?"
    new "Quelque chose ne va pas ?"

    # game/dialogue_taddeus.rpy:170
    old "You look thoughtful."
    new "Vous avez l'air pensif."

    # game/dialogue_taddeus.rpy:191
    old "I guess so..."
    new "J'ai l'impression, oui..."
