...
translate french fff_intro_9b5f5885:
    ...
    gn "Bon.. Bon.. Bonjour cheffe ! Nous som.. sommes là pour prendre un bain. Nous ne sommes pas des têtards, mais on aime la piscine."
...
translate french fff_intro_f2f06e59:
    ...
    p "Je suppose que c'est votre première visite dans notre établissement. Connaissez-vous le fonctionnement de nos bains ?"

# game/dialogue_fff.rpy:13
translate french fff_intro_4ee2e1d3:

    # fiew "She's really in character!"
    fiew "Elle est vraiment dans le personnage !"
...
translate french fff_intro_c96675d8:
    ...
    gn "Je cher..che un certain objet. Certain.es disent, un pr.. pré.. précieux artéfact."
...
translate french fff_intro_d9b478e8:
    ...
    gn "Pour vous, cela n'est qu'un simple objet banal. Mais cela peut sauver le monde !"
...
translate french fff_intro_cc87fd56:
    ...
    gn "Je suis ic..i pour le retr... ret... retrouver avant qu'il ne tombe entre les mains de Waetùl, l'académicien maléfique."

# game/dialogue_fff.rpy:31
translate french fff_intro_c3e8bc75:

    # gn "Or academinician would be more appropriate eheh."
    gn "Ou un académinicien serait plus approprié eheh"
...
translate french fff_intro_3a8faaee:
    ...
    gn "Hum, bref ! Les civils devraient rester en dehors de cette histoire."
...
translate french fff_intro_49accdcf:
    ...
    p "C'est vrai, je comprends. Nous, les civils, avons besoin d'être protégés des choses maléfiques et en tant que détective spécial, vous ne pouvez en dire plus."
...
translate french fff_intro_329018c1:
    ...
    p "Mais, vous savez, si vous m'expliquez, je pourrais mieux vous aider."
...
translate french fff_intro_6ee971f4:
    ...
    p "Êtes-vous préparé à cela, détective ? Je veux dire, vous avez l'air d'être prêt mais peut-être avez-vous besoin d'y réfléchir."

# game/dialogue_fff.rpy:44
translate french fff_intro_37bbb982:

    # feyw "What should we d... d... do?"
    feyw "Que f... fai... faire ?"
...
translate french fff_intro_a120c963:
    ...
    fweyw "Je suis vraiment vraiment VRAIMENT curieux !"
...
translate french fff_intro_89b6928d:
    ...
    gn "Nous sommes prêts ! Notre mission requiert du secret mais au... aussi de l'inspi..ration."
...
translate french fff_intro_b9287d7f:
    ...
    fweyw "Je veux dire, un artéfact caché dans une auberge spirituelle secrète, cela me semble idéal de le mettre ici."
...
translate french fff_intro_a5914c63:
    ...
    p "Bien sûr. Je vais préparer votre bombe de bain tout de suit. Vous pouvez {b}toustes{/b} vous relaxer."
...
translate french fff_intro_3f772f95:
    ...
    fweyw "L'artéfact devrait être dans le deuxième bain du premier étage. Demande ce bain !!"
...
translate french fff_intro_3642ceed:
    ...
    gn "Oh, oui. Pouvons... Puis-je avoir le deuxi.. deu.. deuxième bain du premier étage. S'il vous plaît ?"
...
translate french fff_intro_bbd70c2f:
    ...
    p "Je comprends. Les civils ne peuvent comprendre la voie du SSD."
...
translate french fff_intro_d29796a2:
    ...
    p "Et voilà ! Profitez de votre bain, et de vos recherches."
...
translate french fff_postbath_overpowered_457617e5:
    ...
    gn "Mon cher... cher... cher hôtelier, quelle incroyable enqu..ête ! Votre bain, c'est quelque chose !"
...
translate french fff_postbath_overpowered_9e74372c:
    ...
    fiew "C'était si puissant ! Il nous en faut pour chez nous..."
...
translate french fff_postbath_overpowered_05d78a77:
    ...
    fweyw "Nous irons dans le royaume des humains, nous aurons tant de pouvoirs et nous pourrons sauver tous les mondes du monde !!"
...
translate french fff_postbath_overpowered_24e9db87:
    ...
    p "Je suis ravie que vous vous sentez bien maintenant! Quelle est la suite ?"
...
translate french fff_postbath_overpowered_2d790855:
    ...
    gn "Après toutes ces pr.. précieuses aventures, nous n'avons pas trouvé l'artéfact mais nous sen..tons le pouvoir à l'intérieur de nous maintenant."
...
translate french fff_postbath_overpowered_8b641503:
    ...
    gn "Je pense que c'est ce que l'én.. én.. énigme voulais nous, hmm, me faire trouver."
...
translate french fff_postbath_overpowered_4d65409c:
    ...
    fiew "TANT DE POUVOIR ! Nous allons conquérir le monde dès demain !"
...
translate french fff_postbath_overpowered_1408693c:
    ...
    feyw "V..rai. Frogwey, tu dis que \"l'ami..tié c'est pui..ssant\" dans le monde humain, mais ici, le bain c'est p..puissant ahaha"
...
translate french fff_postbath_overpowered_c2940286:
    ...
    p "On grandit très vite dans nos bains. J'espère que ce pouvoir sera utile pour demain"
...
translate french fff_postbath_satisfied_dfdbd8a2:
    ...
    fweyw "Nul qu'on est rien trouvé mais Frogey a bien joué le jeu. On est rentré dans les bains et on est si bien maintenant *baille*"

# game/dialogue_fff.rpy:177
translate french fff_postbath_satisfied_7bf91463:

    # feyw "Thanks but quiet, or chief will understand."
    feyw "Merci mais chut, ou il va nous entendre."
...
translate french fff_postbath_satisfied_4c8fde3f:
    ...
    feyw "Je sais, mais..mais je ne pense pas que ça soit encore important"

# game/dialogue_fff.rpy:189
translate french fff_postbath_satisfied_4d47676f:

    # fweyw "frown It matters a little..."
    fweyw "*fronce les sourcils* Ça a encore de l'importance..."
...
translate french fff_postbath_satisfied_1966ba83:
    ...
    fie "Oh, allez ! On a kiffé, et demain aussi. Vous vous souvenez comment on a commencé ce jeu ?"
...
translate french fff_postbath_satisfied_cb10eeb3:
    ...
    fey "Ouais. Nous sommes allé·es v..oir le grand Felune et on a rencontré Platyss."
...
translate french fff_postbath_satisfied_c5ff328a:
    ...
    fwey "Et elle détonnait tellement parmi les grenouilles. Mais elle nous a guidé dans notre premier GN inter-esprit."
...
translate french fff_postbath_satisfied_e4d02aa9:
    ...
    fie "Je ne peux plus d'attendre de voir leurs têtes demain, on va devoir leur parler de notre BAIN DE POUVOIR."

# game/dialogue_fff.rpy:194
translate french fff_postbath_satisfied_d397dfa0:

    # fey "Keep c.. calm *yaaaawn*"
    fey "Reste c..calme *baille* "
...
translate french fff_postbath_anger_5c22e0f9:
    ...
    p "Oh non, je suis désolé d'entendre ça. Puis-je faire quelque chose pour aider ?"
...
translate french fff_postbath_anger_d73475da:
    ...
    p "Vous cherchez quelque chose de spécial ? Vous savez que vous auriez pu demander."
...
translate french fff_postbath_anger_f74a89c5:
    ...
    fie "Oh, ne vous moquez pas ! Vous SAVIEZ, nous allons le dire aux organisateurs."

# game/dialogue_fff.rpy:219
translate french fff_postbath_anger_39c4e04b:

    # fey "Hey calm down, it's not his fault..."
    fey "Et du calme, ce n'est pas de sa faute..."
...
translate french fff_postbath_anger_e92d16a2:
    ...
    fwey "Nous lui avons parlé de notre enquête, pourquoi elle ne nous a pas arrêté ?"
...
translate french fff_postbath_anger_ed0eefa9:
    ...
    fwey "C'est vrai, iels ont fait un game design vraiment tout nul et nous y voilà. JE DÉTESTE ÇA ! JE VEUX SAUVER LE MONDE CROOOOA"
...
translate french fff_postbath_anger_ef774ef3:
    ...
    fey "Merci mais nous n.. ne... vou... voulons pas. Nous de..vons leur di... dire."
...
translate french fff_postbath_tired_cb1465a5:
    ...
    fweyw "*baille* Wow, c'est vraiment difficile. La documentation humaine ne ment pas."
...
translate french fff_postbath_tired_77aec78d:
    ...
    p "Désolée d'entendre ça mais, ouais, vous avez fait un bon boulot."
...
translate french fff_postbath_tired_cbfdb6b6:
    ...
    fie "Ça arrive parfois, au moins, on s'est fait des souvenirs."
...
translate french fff_postbath_tired_b97705e0:
    ...
    fwey "Ouais, le dernier puzzle nous amenait ici. C'était grisant mais mauvais design !"
...
translate french fff_postbath_tired_f22b3197:
    ...
    fey "On a pris trop de temps pour deviner, peut... peut-être que c'était trop difficile mais souvenez-vous le premier jour quand on a déci..dé de jouer FFF ?"
...
translate french fff_postbath_tired_e85815fa:
    ...
    fie "Ouais... c'était un sacré personnage ç'uila, et comment on avait fait cherché Crokella dans tout le camp pour..."
...
translate french strings:
    ...
    new "Ne vous en faites pas. Si je vois un client suspicieux, je vous alerterai et je ne ferai mention de notre conversation."

    # game/dialogue_fff.rpy:51
    old "Do you not trust an honest and capable frog?"
    new "Ne faites vous pas confiance à une honnête et habile grenouille ?"

    # game/dialogue_fff.rpy:139
    old "So, how did the investigation go?"
    new "Donc... où en est l'enquête ?"

    # game/dialogue_fff.rpy:139
    old "I'm happy that you feel great now! What's next?"
    new "Je suis ravi que vous vous sentez bien maintenant. Quelle est la suite ?"

    # game/dialogue_fff.rpy:152
    old "You grew up in no time in this bath! Hope your power will be a good fit for tomorrow!"
    new "On grandit très vite dans nos bains. J'espère que ce pouvoir sera utile pour demain"

    # game/dialogue_fff.rpy:152
    old "Great job finding what your riddle meant! I hope you'll have a great festival Mr. Gordon"
    new "Bravo pour avoir résolu ce que l'énigme voulait dire. J'espère que vous passerez un bon festival, M. Gordon."

    # game/dialogue_fff.rpy:213
    old "Oh no, I'm sorry to hear this. Can I do anything to help?"
    new "Oh non, je suis désolé d'entendre ça. Puis-je faire quelque chose pour aider ?"

    # game/dialogue_fff.rpy:213
    old "You were searching for something special? You know, you could have asked."
    new "Vous cherchez quelque chose de spécial ? Vous savez que vous auriez pu demander."

    # game/dialogue_fff.rpy:254
    old "I'm happy to know that you're not too bummed out!"
    new "Ravi que tu ne sois pas trop déprimé."

    # game/dialogue_fff.rpy:254
    old "I'm sorry to hear that, but yeah you did a great job."
    new "Désolée d'entendre ça mais, ouais, vous avez fait un bon boulot."
