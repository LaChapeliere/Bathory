...
translate french croakma_intro_aa4368e8:
    ...
    ca "Bonjour. Je n'ai qu'une heure avant de devoir repartir, avez-vous un bain de libre ?"
...
translate french croakma_intro_a6a17843:
    ...
    ca "Mais j'ai dû aller pondre ces œufs avant le festival, et maintenant, je dois les trimballer avec moi."
...
translate french croakma_intro_2c3f09ed:
    ...
    p "Je vois combien ça peut être fatiguant, surtout si vous devez courir partout avec."

# game/dialogue_croakma.rpy:19
translate french croakma_intro_d6c3bd06:

    # ca "Exactly! I'm lucky to my job isn't too demanding."
    ca "Exactement ! Je suis chanceuse, mon travail ne m'en demande pas tant."
...
translate french croakma_intro_76fb2d0f:
    ...
    ca "Je m'occupe des cristaux pour le portail de transportation."
...
translate french croakma_intro_035db472:
    ...
    ca "Pas grand chose à faire une fois que tout est en place. À part être de garde, s'il y a une urgence."
...
translate french croakma_intro_27d4148b:
    ...
    ca "Mais le festival ne se déroule qu'une fois l'an, et il y a tellement de gens à voir !"
...
translate french croakma_intro_d57d3fd0:
    ...
    ca "Cousin·es éloigné·es, enfants qui ont eu la charmante idée d'aller habiter à l'autre bout du monde..."
...
translate french croakma_intro_9091dbd6:
    ...
    ca "Sans parler des ami·es que je me suis faite en apprenant à tailler le cristal !"
...
translate french croakma_intro_09945f86:
    ...
    p "C'est toute la beauté et la difficulté de ce festival."
...
translate french croakma_intro_a223da2a:
    ...
    ca "Le temps du festival est toujours trépidant, mais je dois me rappeler de m'arrêter pour nourrir ces petites têtes toutes les heures."
...
translate french croakma_intro_a601f9cd:
    ...
    ca "Et ce pot est plus lourd que prévu... je jure que je vais le jeter quelque part..."
...
translate french croakma_intro_b3a8ad80:
    ...
    ca "Je me pose la même question depuis que je les ai."
...
translate french croakma_intro_d24396e4:
    ...
    ca "Je me sens... vous savez, je suis déjà passée par tout ça..."
...
translate french croakma_intro_6cb2b370:
    ...
    ca "Pondre des œufs, être sûre qu'aucun prédateur ne va les manger, promener les petits avec moi ici..."
...
translate french croakma_intro_0211e152:
    ...
    ca "Bien sûr, ce ne sont pas des esprits encore et ce serait une perte d'énergie de les abandonner maintenant."
...
translate french croakma_intro_99f45cc3:
    ...
    ca "N'est-ce pas idiot de se tenir à quelque chose qui vous fait du mal, juste parce que vous y avez déjà mis trop d'énergie ?"
...
translate french croakma_intro_4cb10a6a:
    ...
    ca "J'ai pu les laisser dans ma cabane à outils pendant que j'installais tout."
...
translate french croakma_intro_7aabeb9f:
    ...
    ca "Mais maintenant que les portails sont opérationnels et fonctionnent, j'ai juste besoin d'aller les vérifier une fois par jour."
...
translate french croakma_intro_74c53d14:
    ...
    ca "Ces créatures inutiles ne peuvent pas survivre aussi longtemps sans être nourries, donc je dois les emmener avec moi partout !"
...
translate french croakma_intro_576047f9:
    ...
    p "Donnez-moi une minute pour préparer votre bombe de bain et tout sera prêt."
...
translate french croakma_intro_27b3bbb6:
    ...
    pw "Elle a laissé ses têtards sur le comptoir... est-ce un signe ?"
...
translate french croakma_postbath_mildlyupset_e425ac30:
    ...
    ca "Hum... Je pensais avoir laissé mes têtards ici ?"
...
translate french croakma_postbath_mildlyupset_52725d2e:
    ...
    ca "Je peux les ravoir, maintenant ? Je dois vraiment y aller."
...
translate french croakma_postbath_mildlyupset_06c09a34:
    ...
    pw "Est-ce que j'ai vraiment mal compris la situation ?"
...
translate french croakma_postbath_mildlyupset_75336e30:
    ...
    p "J'ai peur que ça ne soit plus possible."
...
translate french croakma_postbath_mildlyupset_5b0db651:
    ...
    p "J'ai pensé que vous les aviez laissé exprès..."
...
translate french croakma_postbath_mildlyupset_6a9e3de0:
    ...
    p "Ils trempent tranquillement maintenant, se transformant en têtards hallucinogènes."
...
translate french croakma_postbath_mildlyupset_e665bb7e:
    ...
    p "Je m'excuse profondément  pour avoir mal compris..."
...
translate french croakma_postbath_mildlyupset_86196562:
    ...
    ca "Et si vous les récupériez ? Ils n'ont pas trempé si longtemps..."
...
translate french croakma_postbath_mildlyupset_e8c75d80:
    ...
    p "Même si je pouvais les récupérer dans un pot rempli de têtards qui leur ressemblent, je ne pense pas que ça soit une bonne idée."
...
translate french croakma_postbath_mildlyupset_36e333a8:
    ...
    p "La solution, dans laquelle ils sont, est plutôt puissante. Ils ne grandiraient plus {w=1}{cps=*0.5} correctement...{/cps}"
...
translate french croakma_postbath_mildlyupset_e5876f2a:
    ...
    ca "Alors que j'étais reposée, pensant que j'allais pouvoir faire face."
...
translate french croakma_postbath_mildlyupset_04de12f8:
    ...
    p "Je pensais vous rendre service en vous en débarrassant."
...
translate french croakma_postbath_mildlyupset_404fd93a:
    ...
    p "Honnêtement, vous sembliez si fatiguée et surpassée..."
...
translate french croakma_postbath_mildlyupset_55d32228:
    ...
    p "Je sais que vous pensez que c'est un gaspillage d'œufs, mais vous alliez vous effondrer."
...
translate french croakma_postbath_mildlyupset_59e3e4ba:
    ...
    p "Et j'avais le sentiment que vous le saviez et que vous ne pouviez pas prendre la décision."
...
translate french croakma_postbath_mildlyupset_7a08b4b4:
    ...
    p "Je les ai mis dans ma solution hallucinogène. Je fais mes propres réserves de têtards hallucinogènes."
...
translate french croakma_postbath_thankyou_5165ea66:
    ...
    ca "Et merci pour la délicieuse bombe de bain."
...
translate french croakma_postbath_forget_d0dfbd69:
    ...
    ca "Je pensais que le bain allait me faire plus de bien."
...
translate french croakma_postbath_forget_4c993b51:
    ...
    ca "J'ai l'impression d'oublier quelque chose..."
...
translate french croakma_postbath_forget_98d8b6f3:
    ...
    ca "Oh, eh bien, peu importe. Ça ne doit pas être très important..."
...
translate french croakma_postbath_burden_03286cec:
    ...
    ca "Et à mon petit fardeau que j'ai là !"
...
translate french croakma_postbath_burden_c4beeb77:
    ...
    ca "Je me demandais où je les avais laissé..."
...
translate french croakma_postbath_burden_54b27c16:
    ...
    pw "Oh, peut-être que j'aurais dû les mettre de côté."
...
translate french croakma_postbath_burden_caa25f73:
    ...
    pw "Mais, je ne me sentais pas de prendre cette décision à sa place..."
...
translate french strings:
    ...
    new "Je pensais vous rendre service en vous en débarrassant."
    ...
    new "Mais de rien. Je pense que vous devriez penser à vous en débarrasser."

    # game/dialogue_croakma.rpy:229
    old "Would you maybe like another bath?"
    new "Voulez-vous un autre bain peut-être ?"

    # game/dialogue_croakma.rpy:229
    old "I can still see you..."
    new "Je peux toujours vous voir..."
