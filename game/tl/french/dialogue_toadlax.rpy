...
translate french toadlax_intro_a09f4649:
    ...
    p "Bienvenue aux... {w=1.0} Oh ! Toadlax, ça fait longtemps qu'on ne s'est pas vu·es !"
...
translate french toadlax_intro_099cff7d:
    ...
    p "Comment vas-tu ? Tu as prévu de faire des spectacles à ce festival ?"
...
translate french toadlax_intro_c1fb095f:
    ...
    tx "Je doute d'avoir du temps en soirée pour aller chanter..."
...
translate french toadlax_intro_4e959e22:
    ...
    tx "J'adore le défi technique d'adapter mes recettes pour suivre les caprices absurdes des riches et des célèbres..."
...
translate french toadlax_intro_7ee6a73d:
    ...
    tx "Et je vais avoir accès à des ingrédients de haute qualité !"
...
translate french toadlax_intro_770157bf:
    ...
    tx "Le boulot {b}est{/b} cool. Mais certains de ces gens..."
...
translate french toadlax_intro_0e9c99af:
    ...
    tx "J'en ai juste marre de leurs commentaires bien intentionnés sur la qualité de ma cuisine.{w=0.5}.{w=0.5}.{w=0.5} \"pour une grenouille des marais\"."
...
translate french toadlax_intro_8a3c4ac5:
    ...
    p "Tu n'es pas trop sensible, et {b}c'est{/b} terrible !"
...
translate french toadlax_intro_44dd0f7d:
    ...
    tx "Ah ah ! Tu sais toujours quoi dire pour me faire rire !"
...
translate french toadlax_intro_486c58c9:
    ...
    tx "Ceci dit, j'ai pensé à mettre du laxatif dans les hannetons glacés..."
...
translate french toadlax_intro_9908f425:
    ...
    p "Les bains sont toujours calmes en dehors du festival..."
...
translate french toadlax_intro_c6bde185:
    ...
    p "C'est une bonne chose que le temple le plus proche soit le centre de soin de la région, ou on ne verrait que les locaux et des voyageurs occasionnels."

# game/dialogue_toadlax.rpy:65
translate french toadlax_intro_1a70cbb5:

    # tx "Meet anyone interesting recently?"
    tx "Tu as rencontré des gens intéressants récemment ?"
...
translate french toadlax_intro_acb25d2b:
    ...
    p "Et cette famille de dix-huit adelphes, venu·es avec leur papa pour son anniversaire, et toustes étaient adopté·es."
...
translate french toadlax_intro_56d80fe2:
    ...
    tx "Tu as de nouveaux ingrédients pour tes boules de bain ?"
...
translate french toadlax_intro_46887d3b:
    ...
    tx "En plus, la plupart fondent ou se délitent, elles n'explosent pas, je vois pas pourquoi tu insistes pour les appeler bombes."
...
translate french toadlax_intro_f6c128c0:
    ...
    tx "Merci ! Ça va me donner l'occasion de peaufiner mon plan des hannetons au laxatif."
...
translate french toadlax_postbath_revenge_7892dbcf:
    ...
    tx "Et ils ne peuvent pas te blamer si tu ne sais rien. Tu démens, c'est plausible et voilà..."

# game/dialogue_toadlax.rpy:130
translate french toadlax_postbath_revenge_6ae41f1c:

    # p "{cps=*0.2}Ooo-kayyy...{/cps}"
    p "{cps=*0.2}Ooo-kkkkkk...{/cps}"
...
translate french toadlax_postbath_revenge_01d381c4:
    ...
    tx "Merci pour ce bain inspirant !"
...
translate french toadlax_postbath_mellow_53c55c7c:
    ...
    tx "Oui, je me sens toute moelleuse et satisfaite."
...
translate french toadlax_postbath_mellow_2f21a79c:
    ...
    p "Ça serait cool ! Viens quand tu veux !"
...
translate french toadlax_postbath_laxative_e9decbbd:
    ...
    pw "Elle a vraiment l'air de vouloir mettre du laxatif dans la nourriture des VIP..."

# game/dialogue_toadlax.rpy:186
translate french toadlax_postbath_laxative_159a5d23:

    # p "Are you sure that's a good idea?"
    p "Tu es sûre que c'est une bonne idée ?"
